...
<template>
    ...
    <div class="flex gap-2">
        ...
        <Link :href="vendedor.edit_url" @click="abrirLoop">
        ...
        <Dialog>
            ...
            <DialogContent>
                <span>
                    ...
                    <br />
                    <strong>{{ vendedor.user.name }}</strong>
                </span>
                <div class="flex justify-end gap-2">
                    <!-- Eu havia colocado assim @click.prevent="removeVendedor" @click="abrirLoop" funciona mais fica melhor se unificar -->
                    <Button class="bg-red-600 text-white hover:bg-red-700 border-none px-4" @click.prevent="() => { abrirLoop(); removeVendedor(); }">
                        <Trash2Icon class="w-4 h-4 mr-2" />
                        <span>Remover</span>
                    </Button>
                    <DialogClose>
